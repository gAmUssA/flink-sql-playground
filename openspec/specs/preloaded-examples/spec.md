## Purpose
Ensure streaming window examples in the preloaded example set produce meaningful results well within the execution timeout, providing a reliable user experience.
